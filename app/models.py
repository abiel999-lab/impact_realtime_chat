...
class Country(Base):
    ...
    code: Mapped[str] = mapped_column(String(2), primary_key=True)  # ISO-2, e.g. ID, US
...
class Attachment(Base):
    ...
    stored_path: Mapped[str] = mapped_column(String(1024), unique=True)  # uploads/<room_id>/<file>
